# Generated by Django 3.1.7 on 2022-06-03 02:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conjuge', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pessoa_conjuge', to=settings.AUTH_USER_MODEL, verbose_name='Cônjugue')),
                ('discipuladores', models.ManyToManyField(blank=True, related_name='_pessoa_discipuladores_+', to=settings.AUTH_USER_MODEL, verbose_name='Discipuladores')),
            ],
            options={
                'verbose_name': 'Pessoa',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('filho', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='filho', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Filho',
            },
        ...
        migrations.AddField(
            model_name='pessoa',
            name='grupo_caseiro',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pessoas', to='core.grupocaseiro', verbose_name='Grupo caseiro'),
        ),
        migrations.AddField(
            model_name='pessoa',
            name='localidade',
